...
##[br] NOTE: Assumes atlas only has auto-generated tiles.
##Does not save peering bit information or anything else for undo/redo.
static func write_default_preset(
...
##[br] NOTE: Assumes atlas only has auto-generated tiles.
## Does not save peering bit information or anything else for undo/redo.
static func clear_and_resize_atlas(
		urm: EditorUndoRedoManager,
		atlas: TileSetAtlasSource,
		size: Vector2,
) -> void:
...
##[br] NOTE: Assumes atlas only has auto-generated tiles.
## Does not save peering bit information or anything else for undo/redo.
static func clear_and_divide_atlas(
		urm: EditorUndoRedoManager,
		atlas: TileSetAtlasSource,
		divisions: Vector2i,
) -> void:
